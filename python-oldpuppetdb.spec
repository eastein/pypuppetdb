...
License:        Apache
URL:            https://github.com/nedap/oldpuppetdb
Source0:        http://pypi.python.org/packages/source/p/oldpuppetdb/oldpuppetdb-%{version}.tar.gz
...
%description
oldpuppetdb is a library to work with PuppetDB's REST API. It is implemented using the requests library.
